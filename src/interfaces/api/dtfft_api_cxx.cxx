...
namespace dtfft
{
  ...
  Pencil::Pencil() : is_created(false), is_obtained(false) {}
  ...
  Error
  Plan::get_z_slab_enabled(bool *is_z_slab_enabled) const noexcept
  {
    return static_cast<Error>(dtfft_get_z_slab_enabled(_plan, is_z_slab_enabled));
  }

  bool
  Plan::get_z_slab_enabled() const
  {
  ...
  Error
  Plan::get_y_slab_enabled(bool *is_y_slab_enabled) const noexcept
  {
    return static_cast<Error>(dtfft_get_y_slab_enabled(_plan, is_y_slab_enabled));
  }

  bool
  Plan::get_y_slab_enabled() const
  {
  ...
  Error
  Plan::report() const noexcept
  {
    return static_cast<Error>(dtfft_report(_plan));
  }

  Error
  Plan::get_pencil(const int32_t dim, Pencil& pencil) const noexcept
  {
  ...
  Error
  Plan::execute(void *in, void *out, const Execute execute_type, void *aux) const noexcept
  {
  ...
  Error
  Plan::forward(void *in, void *out, void *aux) const noexcept
  {
    return execute(in, out, Execute::FORWARD, aux);
  }

  Error
  Plan::backward(void *in, void *out, void *aux) const noexcept
  {
    return execute(in, out, Execute::BACKWARD, aux);
  }

  Error
  Plan::transpose(void *in, void *out, const Transpose transpose_type) const noexcept
  {
  ...
  Error
  Plan::transpose_start(void *in, void *out, const Transpose transpose_type, dtfft_request_t *request) const noexcept
  {
  ...
  Error
  Plan::transpose_end(dtfft_request_t request) const noexcept
  {
  ...
  Error
  Plan::get_alloc_size(size_t *alloc_size) const noexcept
  {
  ...
  Error
  Plan::get_element_size(size_t *element_size) const noexcept
  {
  ...
  Error
  Plan::get_alloc_bytes(size_t *alloc_bytes) const noexcept
  {
  ...
  Error
  Plan::get_executor(Executor *executor) const noexcept
  {
  ...
  Error
  Plan::get_precision(Precision *precision) const noexcept
  {
  ...
  Error
  Plan::get_dims(int8_t *ndims, const int32_t *dims[]) const noexcept
  {
  ...
  Error
  Plan::get_grid_dims(int8_t *ndims, const int32_t *grid_dims[]) const noexcept
  {
  ...
  Error
  Plan::mem_alloc(size_t alloc_bytes, void **ptr) const noexcept
  {
    return static_cast<Error>(dtfft_mem_alloc(_plan, alloc_bytes, ptr));
  }

  void *
  Plan::mem_alloc(size_t alloc_bytes) const
  {
    void *ptr = nullptr;
  ...
  Error
  Plan::mem_free(void *ptr) const noexcept
  {
    return static_cast<Error>(dtfft_mem_free(_plan, ptr));
  }

  Error
  Plan::destroy() noexcept
  {
    return static_cast<Error>(dtfft_destroy(&_plan));
  }

  Error
  Plan::get_backend(Backend& backend) const noexcept
  {
  ...
  Error
  Plan::get_stream(dtfft_stream_t *stream) const noexcept
  {
  ...
  Error
  Plan::get_platform(Platform& platform) const noexcept
  {
