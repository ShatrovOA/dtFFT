...
int main(int argc, char* argv[])
{
    ...
    if (element_size != (size_t)sizeof(float complex)) {
        fprintf(stderr, "element_size /= sizeof(float complex)\n");
