...
for 3D case. Where :math:`X, Y, Z` are the spatial dimensions of the data, :math:`X` being the fastest varying index and :math:`P_0, P_1, P_2, Q_1, Q_2, Q_2'` are the number of processes in the appropriate direction.
